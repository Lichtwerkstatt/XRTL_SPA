import LM1XY_Background from './media/LM1XY_outline.png'
import RotaryCtrl from '../UI/CtrlUnits/RotaryCtrl';
import Window from '../UI/experimentUI/Window';

/**
 * LM1XY component window
 * 
 * @description  This React component returns a window with the content for the LM1XY component window.
 *  
 ...
 * 
 * @returns {React.ReactElement} LM1XY component window
 */
const LM1XY = (props) => {
  return (
    <Window
