...
const Overlay = (props) => {
    ...
    let MAP = {
        ...
        areas: [
            ...
            { controlId: "screen", shape: "poly", coords: Strech_to_Screen(boxTransform([545, 1, 1205, 1, 1132, 201, 650, 199])), preFillColor: preFill_Color, fillColor: fill_Color, desc: 'Screen' },
