      ...
      <group name="Scene">
...

        {
          ...
          <group>
            ...
            >
              {props.showTags && <DescriptiveTag position={[0, 1, -0.1]} title="Beamsplitter" description="Custom Revolving Mount" />}
              <mesh
                name="Cylinder"
                castShadow
                receiveShadow
        ...
        {(props.showLED === 'white') &&
          <group>
            ...
            >
              {props.showTags && <DescriptiveTag position={[0, 11, 0]} title="LED White" description="Custom Revolving Mount" />}
              <mesh
                name="Cylinder007"
                castShadow
                receiveShadow
        ...
        {(props.showLED === 'red') &&
          <group>
            ...
            >
              {props.showTags && <DescriptiveTag position={[0, 11, 0]} title="LED Red" description="Custom Revolving Mount" />}
              <mesh
                name="Cylinder007"
                castShadow
                receiveShadow
