        ...
        <div className={styles.Temp}>
            <div className={styles.Canvas2}>
                ...
                <div className={styles.Select}>
                    <Select sx={{ zIndex: 1500, marginBottom: -10 }} title='Average time (ms)' component={props.component} led={props.led} online={props.online} option='averageTime' />
                    <Select title='Update time (s)' component={props.component} led={props.led} online={props.online} option='updateTime' />
                </div>
            </div>
        </div>
    )
