      ...
      <div>
        <div className={styles.mainWrapper} >
          ...
          <p id={'2'} style={{ display: 'none' }}>
            ...
            Our remote experiment allows you to control the components of a Michelson interferometer by simply tapping on their virtual twin. This opens a window that allows you to adjust the settings.
